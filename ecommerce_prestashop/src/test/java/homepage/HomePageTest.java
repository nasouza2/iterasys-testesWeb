...
public class HomePageTest extends BaseTests {
	...
	public void testValidarDetalhesDoItem_DescricaoEValorIguais() {
		...
		// quando clicar no produto, devemos ir para a pagina de produto e não ficar na home
	...
	public void incluirProdutoNoCarrinho_ProdutoIncluidoComSucesso() {
		...
		// Pré-condição: validando se o usuário está logado; se nao estiver, chama o metódo para logar.
